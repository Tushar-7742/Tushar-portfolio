...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const interactiveElements = document.querySelectorAll(
    "a, button, .info-card, .certificate-card, .tool-item, .project-item, .service-card, .blog-card",
  )
  ...
  const animatedElements = document.querySelectorAll(
    ".about-text, .info-card, .certificate-card, .tool-item, .project-item, .service-card, .blog-card",
  )
  ...
  // Track if certificate swiper is initialized
  ...
  // Initialize certificate swiper for mobile only
  function initCertificateSwiper() {
    if (isMobile()) {
      if (!certificateSwiper) {
        certificateSwiper = new Swiper(".certificates-swiper", {
          slidesPerView: 1,
          spaceBetween: 20,
          loop: true,
          pagination: {
  ...
  // Initialize certificate swiper on page load
  initCertificateSwiper()

  // Re-initialize certificate swiper on window resize
  ...
  const projectData = {
    project1: {
      ...
      description:
        "A comprehensive brand identity design for a sustainable products company. The project included logo design, color palette, typography, packaging design, and brand guidelines.",
    ...
    project2: {
      ...
      description:
        "Vibrant poster design for an annual music festival featuring a mix of illustration and typography to create an eye-catching visual that captures the energy of the event.",
    ...
    project3: {
      ...
      description:
        "User interface design for a health tracking application with a focus on clean, intuitive design and accessibility. The project included wireframing, prototyping, and final UI design.",
      images: ["/placeholder.svg?height=400&width=600", "/placeholder.svg?height=400&width=600"],
      client: "FitTrack",
      year: "2023",
    ...
    project4: {
      ...
      description:
        "A series of minimalist logo designs created for various clients across different industries. Each logo was designed with versatility and brand recognition in mind.",
    ...
    project5: {
      ...
      description:
        "Complete UX/UI overhaul for an online store to improve user experience, increase conversion rates, and modernize the visual design while maintaining brand identity.",
    ...
    project6: {
      ...
      description:
        "Collection of posters designed for an independent film showcase, featuring a cohesive visual language while highlighting the unique aspects of each featured film.",
      images: ["/placeholder.svg?height=800&width=600", "/placeholder.svg?height=800&width=600"],
    ...
    project7: {
      ...
      description:
        "A series of digital abstract artworks created for a gallery exhibition, exploring themes of motion, color, and emotion through digital manipulation techniques.",
      images: ["/placeholder.svg?height=600&width=600", "/placeholder.svg?height=600&width=600"],
    ...
    project8: {
      ...
      description:
        "Complete brand identity for an innovative tech startup, including logo design, visual language, marketing materials, and digital assets.",
      images: ["/placeholder.svg?height=400&width=600", "/placeholder.svg?height=400&width=600"],
    ...
    project9: {
      ...
      description:
        "Comprehensive social media campaign for a new product launch, including content strategy, visual design, and engagement tactics.",
      images: ["/placeholder.svg?height=400&width=600", "/placeholder.svg?height=400&width=600"],
      client: "InnovateTech",
      year: "2023",
    ...
    project10: {
      ...
      description:
        "User-centered interface design for a travel booking application, focusing on intuitive navigation and engaging visual elements.",
      images: ["/placeholder.svg?height=400&width=600", "/placeholder.svg?height=400&width=600"],
      client: "WanderWise",
      year: "2023",
    ...
    project11: {
      ...
      description:
        "Collection of character and concept illustrations for a fantasy book series, bringing the author's vision to life through detailed digital artwork.",
      images: ["/placeholder.svg?height=600&width=600", "/placeholder.svg?height=600&width=600"],
    ...
    project12: {
      ...
      description:
        "Complete rebranding for an upscale restaurant, including new logo, menu design, interior graphics, and marketing materials.",
      images: ["/placeholder.svg?height=400&width=600", "/placeholder.svg?height=400&width=600"],
    ...
    project13: {
      ...
      description:
        "Custom template designs for a lifestyle brand's social media presence, creating a cohesive and engaging visual identity across platforms.",
      images: ["/placeholder.svg?height=400&width=600", "/placeholder.svg?height=400&width=600"],
