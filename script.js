...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const interactiveElements = document.querySelectorAll('a, button, .info-card, .certificate-card, .tool-item, .project-item');
    ...
    const animatedElements = document.querySelectorAll('.about-text, .info-card, .certificate-card, .tool-item, .project-item');
